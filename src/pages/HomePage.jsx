  ...
  return (
    <div className='bg-white'>
      <Carousel
        ...
        autoPlay={true}
        autoPlaySpeed={6000}  // 5 seconds
        infinite={true}        // Loop through items infinitely
        arrows={false}         // Hide left and right arrows
        showDots={false}       // Hide navigation dots
      >
        <div className='relative h-[100vh] bg-white hm-m1'>
          <img src="https://www.incredibleindia.org/content/dam/incredible-india-v2/images/home/SOU_new.jpg/_jcr_content/renditions/cq5dam.web.1800.737.jpeg" alt='hm-img' className='h-[100vh] w-full'/>
        ...
        <div className='relative h-[90vh] bg-white hm-m1'>
          <img src="https://static-blog.treebo.com/wp-content/uploads/2018/06/Uttar-Pradesh.jpg" alt='hm-img' className='h-[100vh] w-full'/>
          <div className="absolute top-1 flex justify-between w-full hm-h1">
            <div className='ms-2'>a</div>
            <div><h1>ATALTUYA BHARAT</h1></div>
            <div className='me-2'></div>
        ...
        <div className='relative h-[90vh] bg-white hm-m1'>
          <img src="https://i.pinimg.com/736x/f4/c4/3c/f4c43cd02794709f565d65d40a83d66b.jpg" alt='hm-img' className='h-[100vh] w-full'/>
          <div className="absolute top-1 flex justify-between w-full hm-h1">
            <div className='ms-2'>a</div>
            <div><h1>ATALTUYA BHARAT</h1></div>
            <div className='me-2'></div>
